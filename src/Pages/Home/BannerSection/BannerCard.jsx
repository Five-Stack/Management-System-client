...
function BannerCard() {
    ...
    return (
        <div className="lg:w-[60%] bg-[#115ED0] p-8 lg:relative lg:left-1/2 lg:-translate-x-1/2 lg:bottom-12 lg:rounded-lg shadow-md grid md:grid-cols-2 lg:grid-cols-3 items-center gap-6 z-20">
            {
