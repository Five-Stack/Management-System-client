...
const Alert = () => {
    ...
    return (
        ...
        <div className={`h-[284px] bg-[#DCE1EE] mx-auto mt-10 rounded-lg flex justify-center items-center px-4 relative ${showAlert ? 'block' : 'opacity-0 transition-opacity duration-200'} ${hidden && 'hidden'} `}>
