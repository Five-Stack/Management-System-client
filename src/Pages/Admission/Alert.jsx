    ...
    return (
        ...
        <div className="px-1">
            <div className={`h-[200px] md:h-[284px] bg-[#DCE1EE] mx-auto mt-5 md:mt-10 md:mb-16 rounded-2xl flex justify-center items-center px-4 relative ${showAlert ? 'block' : 'opacity-0 transition-opacity duration-200'} ${hidden && 'hidden'} `}>
                ...
                <p className="text-center text-sm md:text-lg md:font-medium text-[#4B537D]">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not o</p>
            </div>
        </div>
